...
public interface BaseRelationshipRepository extends Neo4jRepository<BaseRelationship, Long> {
    ...
    BaseRelationship<BaseNode,BaseNode> getBaseRelationshipByName(@Param("name") String name);
    ...
    List<BaseRelationship<BaseNode,BaseNode>> findRelationshipByStarNameAndEndName(@Param("name") String name,
    ...
    List<BaseRelationship<BaseNode,BaseNode>> getListRelationshipByPage(@Param("pageIndex") int pageIndex,
                                                     @Param("pageSize") int pageSize,
                                                     @Param("type") String type);

    @Query("MATCH  p=(n:BaseNode)-[r:Ref]->(m:BaseNode) where n.type={type}  RETURN r")
    List<BaseRelationship<BaseNode,BaseNode>> getListRelationshipByType(@Param("type") String type);
    ...
    List<BaseRelationship<BaseNode,BaseNode>> getPersonNodRelationByType(@Param("type") String type);
